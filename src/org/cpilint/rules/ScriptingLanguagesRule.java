...
final class ScriptingLanguagesRule extends RuleBase {
	...
	public void inspect(IflowArtifact iflow) {
		...
		Function<ScriptingLanguage, Function<XdmNode, Issue>> issueFunctionFunction = l -> n -> 
			new DisallowedScriptingLanguageIssue(ruleId, tag, model.getStepNameFromElement(n), model.getStepIdFromElement(n), l, getSeverity());
